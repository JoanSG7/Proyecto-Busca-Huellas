...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-08-2026 a las 17:45:25
...
(2, 13, 'Informe 2', 'mascotas_por_fecha', 'Archivo PDF generado: Informe personalizado', 'informe_99d9ff4837684e95956febf1f70fd418.pdf', NULL, '2026-08-31', 1),
(3, 13, 'Informe 3', 'mascotas_por_fecha', 'Archivo PDF generado: Informe personalizado', 'informe_42e37b296fe3430a94674a70da6e8f62.pdf', NULL, '2026-08-31', 1),
(4, 13, 'Informe 4', 'mascotas_por_fecha', 'Archivo PDF generado: dfghdfgh', 'informe_dc2430224a9d4bc28367a309b8d5141d.xlsx', NULL, '2026-08-31', 1),
(5, 13, 'Informe 5', 'mascotas_por_fecha', 'Archivo PDF generado: dfghdfg', 'informe_70f552009e7c472abb2bdaeb7db34b18.pdf', NULL, '2026-08-31', 1),
(8, 13, 'ghjfghjfh', 'mascotas_por_fecha', 'Archivos PDF y Excel generados: ghjfghjfh', 'informe_37bef3dc88dc4420bc6e353e3a19f16a.pdf', 'informe_22687a8db0d942618bd50d96d9c67f7c.xlsx', '2026-08-31', 1),
(9, 13, 'ghhhhhhh', 'mascotas_por_fecha', 'Archivos PDF y Excel generados: ghhhhhhh', 'informe_08d38ac77faa4d7b8042ed05e839454e.pdf', 'informe_bc151a634acb43a7aebd52e32c26844a.xlsx', '2026-08-31', 1);
...
--
ALTER TABLE `alerta`
  MODIFY `id_alerta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
